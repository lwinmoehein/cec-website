    ...
    return (
        <section className="relative h-[90vh] min-h-[600px] w-full overflow-hidden">
            ...
            <div className="absolute inset-0">
                <Image
                    src="/images/banner.png" // Using the provided banner image
            ...
            <div className="container relative z-10 flex h-full flex-col justify-center px-4 sm:px-6 lg:px-8 text-white">
                ...
                >
                    ...
                    <div className="flex flex-col sm:flex-row gap-5">
                        ...
                        >
                            <Button size="lg" className="w-full bg-black hover:bg-zinc-900 text-white border border-white/20 h-16 px-6 rounded-2xl flex items-center gap-4 transition-all hover:scale-105 hover:shadow-xl group">
